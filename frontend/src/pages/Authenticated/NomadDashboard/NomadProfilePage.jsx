...
import {setBookings} from "../../../store/slices/generalSlice.js";
                ...
                <EditProfileForm>
                    ...
                    <UserInfo>
                        ...
                        <UserDetails>
                            ...
                            <UserTitle>Digital Nomad</UserTitle>
                            <BadgeContainer>
                                <Badge
                                    color="blue">{userData?.verification_status === "accepted" ? "Verified Member" : "Member not verified"}</Badge>
                                <Badge color="purple">{bookings.length} Bookings</Badge>
                            </BadgeContainer>
                        </UserDetails>
                    </UserInfo>
                        ...
                        {isVerifiedDocsVisible && (
                            <FormContainer>
                                <DocumentSectionWrapper>
                                    ...
                                    <DocumentWrapper>
                                        <DocumentName>job_contract.pdf</DocumentName>
                                        <VerifiedBadge>
                                            Verified
                                        </VerifiedBadge>
                                        {/*<ButtonUpload onClick={(e) => { e.preventDefault(); if (isEditing) jobContractRef.current.click(); }} disabled={!isEditing}>
                                    Edit
                                </ButtonUpload>*/}
                                        <input type="file" name="uploadContract" ref={jobContractRef} hidden
                                               onChange={handleChange}/>
                                    </DocumentWrapper>
                                    {uploadedFiles.uploadContract && (
                                        <PreviewContainer>
                                            <FilePreview>
                                                <FileName>{uploadedFiles.uploadContract.name}</FileName>
                                                <RemoveButton onClick={() => handleRemove('uploadContract')}>
                                                    Remove
                                                </RemoveButton>
                                            </FilePreview>
                                        </PreviewContainer>
                                    ...
                                    <DocumentWrapper>
                                        <DocumentName>visa.pdf</DocumentName>
                                        <VerifiedBadge>
                                            Verified
                                        </VerifiedBadge>
                                        {/*<ButtonUpload onClick={(e) => {
                                    e.preventDefault();
                                    if (isEditing) visaPermitRef.current.click();
                                }} disabled={!isEditing}>
                                    Edit
                                </ButtonUpload>*/}
                                        <input type="file" name="uploadVisa" ref={visaPermitRef} hidden
                                               onChange={handleChange}/>
                                    </DocumentWrapper>
                                    {uploadedFiles.uploadVisa && (
                                        <PreviewContainer>
                                            <FilePreview>
                                                <FileName>{uploadedFiles.uploadVisa.name}</FileName>
                                                <RemoveButton onClick={() => handleRemove('uploadVisa')}>
                                                    Remove
                                                </RemoveButton>
                                            </FilePreview>
                                        </PreviewContainer>
                                    ...
                                    <DocumentWrapper>
                                        <DocumentName>proof_of_income.pdf</DocumentName>
                                        <VerifiedBadge>
                                            Verified
                                        </VerifiedBadge>
                                        {/*<ButtonUpload onClick={(e) => {
...
export default NomadProfilePage;
